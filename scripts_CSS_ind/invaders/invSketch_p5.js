...
var sprShip1, sprShip2, sprShipT, sprShipF;
...
function preload(){
	...
	sprites = loadImage("scripts_CSS_ind/invaders/assets/sprites/invSprites1.png");
	...
	sPhaserB = loadSound("scripts_CSS_ind/invaders/assets/sounds/phasers/67426__aji__pair03.wav");
...
function setup(){
	...
	sprShip1 = sprites.get(50,450,102,123);
	sprShipF = sprites.get(200,450,102,123);
