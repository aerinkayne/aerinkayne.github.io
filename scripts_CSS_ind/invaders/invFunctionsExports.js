//util functions: sort, collision, camera
//util objects: buttons, also gameScreen (maybe move to own)
//other objects: guns, shields, poweups (todo: move these to own file)

//bubble sorts an array by the given key's value
export function sortArrByProp(arr, str) {
    let holder;
...
//cam
export function gameCamera (ship) {
...
//classes:  button, gameScreen, Weapon, Powerup, Shield
export class Button{
...
export class GunBtn extends Button{
...
export class ShieldDrop extends PowerUp{
	constructor(vessel){
		super(vessel);
		this.w = 12;
		this.h = 12;	
